...
public class Stitched<T extends Entity> extends EntityModel<T> {
	...
	// Alanları orijinaldeki gibi private bıraktım, ama Renderer erişebilsin diye
	// "AnimatedModel" içindeki "root" değişkenini kullanacağız.
	...
	// DÜZELTME BURADA: 'Entity' yerine 'T' kullanıldı.
	// Override hatası almamak için bu şart.
	@Override
	...
	// Renderer içindeki animasyon sınıfının kök parçaya erişebilmesi için helper metod
