...
public class BrawlerEntity extends Monster {
	public BrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ReverieModEntities.BRAWLER.get(), world);
	}

	public BrawlerEntity(EntityType<BrawlerEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 60;
		setNoAi(false);
