...
public class AbilityLightning implements StitchedAbility {
    ...
    private void spawnElectricBeam(StitchedEntity start, LivingEntity end) {
        ...
        // DÜZELTME: Çıkış Noktası (Kafa/Bobin Hizası)
        // getEyeHeight() göz hizasıdır. +0.5 ile kafanın tepesindeki bobine çıkıyoruz.
        Vec3 startPos = start.position().add(0, start.getEyeHeight() + 0.5, 0);

        // Hedef: Düşmanın Göğsü (Burası iyi, değişmedi)
