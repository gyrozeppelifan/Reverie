...
public class ReverieModSounds {
	...
	public static final RegistryObject<SoundEvent> GONG_PLAY = REGISTRY.register("gong_play", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("reverie", "gong_play")));
	...
	public static final RegistryObject<SoundEvent> MEDITATION_AMBIANCE = REGISTRY.register("meditation_ambiance", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("reverie", "meditation_ambiance")));
}
